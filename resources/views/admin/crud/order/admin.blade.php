                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 ">
                                    <div class='input-group mb-3'>
                                        <input type="text" class="form-control" id="passport_key" name="passport_key" @isset($passport_key) value="{{ $passport_key }}" @endisset placeholder="ابحث برقم جواز السفر">
                                    </div>
                                </div>
                                  <div class="col-md-2 ">
                                    <div class='input-group mb-3'>
                                        <select class="form-control " name="nationality_id" id="nationality_id">
                                            ...
                                            @foreach ($natinalities as $key => $country)
                                                <option value="{{ $country->id }}" @if($nationality_id== $country->id ) selected @endif>{{ $country->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 ">
                                    ...
                                    <div class="col-md-2 text-end">
                                        @if(count($_GET)>0 )
                                            <a id="cancel_request" href="{{ route('admin-orders.index') }}" class="btn btn-danger">إلغاء البحث</a>
                                        @endif
    ...
    <script>
       ...
       $("#btnSubmit").click(function(){
             if($("#cancel_request").html()==undefined && $('.cancel_request_add').hide())  {
                $('   <a  href="{{route('admin-orders.index')}}" class="btn btn-danger cancel_request_add " style="margin:5px 5px 5px 5px;"> إلغاء البحث </a>').insertAfter("#btnSubmit");
            }
