                        ...
                        <div class="row ">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input data-validation="required" type="text" class="form-control" value=""
                                        id="title_ar" name="title" placeholder="{{ __('admin.title') }} ">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="editor" name="description_ar" required></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            $.ajax({
                ...
                success: function(data) {
                    window.setTimeout(function() {
                        ...
                        $('#exampleModalLabel').html('اضافة مدونة جديدة')
