...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('blogs.update', $blog->id) }}" method="post" id="Form">
                @csrf
                @method('PUT')
                <div class="row ">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input data-validation="required" type="text" class="form-control" id="title_ar"
                                name="title_ar" value="{{ $blog->title_ar }}" placeholder="{{ __('admin.title') }} ">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <img src="{{ get_file($blog->image) }}" style="width: auto; height:50px">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-2">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="editor" name="description_ar">{!! $blog->description_ar !!}</textarea>
                        </div>
                    </div>
