                ...
                <div class="card-body">
                    ...
                    <table id="Datatable" class="table table-striped table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tr>
                            ...
                            <th>العنوان</th>
                            <th>رقم التواصل</th>
                            <th>عدد العماله المطلوبه</th>
                            <th>رقم التأشيرة</th>
                            <th>متطلبات اخرى</th>
                            <th>نوع العمل المطلوب</th>
...
@section('js')
    ...
    <script>
        ...
        datatable_selector = $('#Datatable').DataTable({
            ...
            "searching": true,
            'iDisplayLength': 20,
            "ajax": "{{route('laborDemands.index')}}",
            "columns": [
                {"data": "delete_all", orderable: false, searchable: false},
                {"data": "facility_name", orderable: false, searchable: true},
                {"data": "record_number", orderable: false, searchable: false},
                {"data": "address", orderable: false, searchable: false},
                {"data": "contact_number", orderable: false, searchable: false},
                {"data": "number_worker", orderable: false, searchable: false},
                {"data": "visa_number", orderable: false, searchable: false},
                {"data": "other_requirements", orderable: false, searchable: false},
                {"data": "job_id", orderable: false, searchable: false},
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                console.log(result)
                if (result.value) {
                    var url = '{{ route("laborDemands.destroy", ":id") }}';
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        if (id.length > 0) {
                            ...
                            $.ajax({
                                url: '{{route('laborDemands.delete.bulk')}}',
                                type: 'DELETE',
                                data: {id: id},
                                success: function (data) {
                                    $("#bulk_delete").hide()
