        ...
        <div class="d-flex">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('sliders.index') }}">
                                    <img src="{{ asset('dashboard') }}/assets/images/brands/bitbucket.png"
                                        alt="bitbucket">
                                    <span>البانر</span>
                                </a>
                            </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="{{ route('admins.index') }}">
                                    <img src="{{ asset('dashboard') }}/assets/images/brands/mail_chimp.png"
                                        alt="mail_chimp">
                                    <span>المشرفين</span>
                                </a>
                            </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user useImageEdit"
                        src="{{ admin()->user()->image ? get_file(admin()->user()->image) : asset('namiLogo.svg') }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 nameEdit"
                        key="t-henry">{{ admin()->user()->name }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item d-block" href="{{ route('settings.index') }}"><span
