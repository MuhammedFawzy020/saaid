...
@section('meta_description')
    طلب استقدام عامل/عاملة منزلية بسرعة وبطرق قانونية. املأ النموذج للحصول على عرض سعر وخدمة مهنية.
@endsection
@section('keywords')
    <meta name="keywords"
...
@section('content')
    <div class="">
        <div class="row m-0 p-0  p-4 text-center backgound-color-orange mb-4">
            ...
            <h2 class="display-3 mt-3 color-white">
            ...
            <figure class="p-2">
                ...
                <figcaption class="blockquote-footer color-white">
                    ...
                    {{-- decorative heading removed (duplicated) --}}
                    ...
                    <div class="container selectCustomerService">
                        <form method="post" action="{{ route('front.crp', $cv->id) }}">
                            ...
                            <div class="row justify-content-center">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="name" value="{{ old('name') }}" required
                                        ...
                                        @if ($cv->is_rental == true)
                                            <div class="col-md-8">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="delivery_to"
                                                        name="delivery_to" value="1">
                                ...
                                <div class="headTitle">
                                    <h2 class="sr-only">اختيار ممثل خدمة العملاء</h2>
                                    <p>
                                ...
                                <div class="choose">
                                    @foreach ($admins as $admin)
                                        <h2 class="display-3 mt-3 color-white">
                                            علي بعد خطوة واحدة من إكمال الطلب
                                        </h2>
                                        id="option{{ $admin->id }}">
                                        <label class="btn btn-outline" for="option{{ $admin->id }}">
                                            <img src="{{ asset('frontend') }}/img/img/customerService2.png"
                                                alt="صورة خدمة العملاء {{ $admin->name }}">
