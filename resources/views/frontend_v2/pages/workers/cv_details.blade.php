    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 mb-2">
                ...
                <div class="card" style="padding:3px;height:100%;margin:20px; border: 5px solid #5B79AFl;height:fit-content" id="pdf-content">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-2">
                                            @if ($cv->cv_file)
                                                ...
                                                <img src="{{url('/')}}/frontend/images/users/Driver.jpg" style="height:200px;width:100%" class="img-fluid rounded-start" alt="...">
                                                </a>
                                            @else
                                                <a href="{{ url('/') }}/frontend/images/comment-1-1.jpg" data-fancybox data-caption="{{ $cv->name }}">
                                                <img src="{{ url('/') }}/frontend/images/comment-1-1.jpg" class="img-fluid rounded-start"  data-fancybox data-caption="{{ $cv->name }}" alt="...">
                                                </a>
                                            @endif
                                        </div>
                                        <div class="col-md-10">
                                        ...
                                        <div class="row">
                                          <div class="col-lg-4">
                                            <div class="row" >
                                                ...
                                                <p style="font-weight:bolder;">{{ $cv->experinces?->country?->title }}</p>
                                            </div>
                                          </div>
                                          <div class="col-lg-4">
                                            <div class="row">
                                                <p style="margin:0px;">المدة : </p>
                                                <p style="font-weight:bolder;">{{ $cv->experinces?->exp_period }}</p>
                                            </div>
                                          </div>
                                          <div class="col-lg-4">
                                            <div class="row" >
                                                <p style="margin:0px;">الوظيفة : </p>
                                                <p style="font-weight:bolder;">{{ $cv->experinces?->job?->title }}</p>
                                            </div>
                                          </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row" >
                                            ...
                                            <p style="font-weight:bolder;">{{ $cv->passport_city_name?->title }}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="row" >
