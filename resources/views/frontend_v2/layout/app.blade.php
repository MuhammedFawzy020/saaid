...
<head>
    ...
    <meta name="google-site-verification" content="mBrORr-o2_T4juGzhvDamw9IvBhrwMQcJh08EdjFlGI" />
</head>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TWNGVDP8" height="0" width="0"
    ...
    <!-- Core JS: single jQuery, Swiper, WOW and Bootstrap includes -->
    ...
    <!--<script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/68bded7e95c82f1923643a24/1j4iufef2';
            s1.charset = 'UTF-8';
